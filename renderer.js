...
var Renderer = (function () {
    ...
    */
    ...
    function Renderer (canvas, wgl, gridDimensions, onLoaded) {
        ...
        this.thicknessColorTexture = wgl.buildTexture(wgl.RGBA, wgl.FLOAT, SHADOW_MAP_WIDTH, SHADOW_MAP_HEIGHT, null, wgl.CLAMP_TO_EDGE, wgl.CLAMP_TO_EDGE, wgl.LINEAR, wgl.LINEAR);
        ...
        wgl.createProgramsFromFiles({
            ...
            renderProgram: {
                vertexShader: 'otherShaders/common.vert',
                fragmentShader: 'otherShaders/common.frag',
                attributeLocations: { 'a_textureCoordinates': 0}
            },
            renderDepthProgram: {
                vertexShader: 'otherShaders/depth.vert',
    ...
    Renderer.prototype.draw1 = function (simulator, projectionMatrix, viewMatrix){
        ...
        var renderState = wgl.createDrawState()
            ...
            .uniformTexture("u_thickness", 1, wgl.TEXTURE_2D, this.thicknessColorTexture)
            .uniform2f("u_textureSize", this.canvas.width, this.canvas.height)
            .uniform4f("u_liquidColor", 0.275,0.65,0.85,0.5)
